...
the Top Influencers screen (Figma node 6028:7456) in
assets/images/influencers/, same 900px cap scripts/resize-home-assets.py
...
DIR = os.path.join(os.path.dirname(__file__), "..", "assets", "images", "influencers")
CAP = 900

# Explicit filenames only - this directory also holds icon PNGs
# (verified-check/star/location-pin, rasterized by
# rasterize-influencers-assets.py) that must stay untouched raster PNGs,
