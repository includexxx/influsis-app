...
brand-logo exports in assets/images/brands/, same approach and 200px cap as
scripts/resize-home-assets.py's brand-logo-*.
"""

import os
from PIL import Image

DIR = os.path.join(os.path.dirname(__file__), "..", "assets", "images", "brands")
CAP = 200
