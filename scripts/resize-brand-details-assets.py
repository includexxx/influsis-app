...
the Brand Details screen (Figma node 6001:37719) in
assets/images/brand-details/, same approach as
...
DIR = os.path.join(os.path.dirname(__file__), "..", "assets", "images", "brand-details")
