...
Creators screen (Figma node 6028:7456) into PNGs, same approach as
...
JOBS = [
    ("creators/verified-check.svg", "creators/verified-check.png", 50, 48),
    ("creators/star.svg", "creators/star.png", 64, 64),
    ("creators/location-pin.svg", "creators/location-pin.png", 80, 80),
]
