...
const megaphoneIcon = require('@/assets/images/search/megaphone.png');
...
// "No results" illustration (Figma node 6123:7599) used by the Search
// screen's empty state, paired with EmptyState for the title/description.
// A megaphone glyph centered in a white circle ("lens"), inside a light
// gray disc with four scattered decorative dots.
function SearchIllustration({ style, testID }: SearchIllustrationProps) {
  ...
  return (
    <View style={[styles.root, style]} testID={testID}>
      ...
      <View style={styles.lens}>
        <Image source={megaphoneIcon} style={styles.icon} contentFit="contain" />
      </View>
    </View>
  );
}
