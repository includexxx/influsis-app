...
// (scenes/main/Home.tsx). Registered as a root-level route (app/live-
// campaign.tsx, outside the (main) Tabs group) since Figma shows no tab bar
// on this screen, the same reasoning as /notifications (see
