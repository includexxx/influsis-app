...
// Heard & McDonald Islands, `tf` French Southern Territories, `un` United
// Nations) are deliberately absent - consumers filter on presence, so a
// missing key drops the row instead of rendering an `undefined` prefix.
