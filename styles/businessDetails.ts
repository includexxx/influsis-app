...
// Shared fragments for the Business Details scene (scenes/main/BusinessDetails.tsx).
// Like Gig Details and Creator Profile, the banner photo is full-bleed
...
// the whole screen.
export const businessDetailsStyle = StyleSheet.create({
  headerRow: {
